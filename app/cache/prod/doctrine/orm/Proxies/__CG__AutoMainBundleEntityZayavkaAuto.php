 ...
 */
class ZayavkaAuto extends \Auto\MainBundle\Entity\ZayavkaAuto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'user_id', 'region', 'mark', 'model', 'body', 'year', 'color', 'run', 'new', 'vip', 'price', 'description', 'date_add', 'date_update', '' . "\0" . 'Auto\\MainBundle\\Entity\\ZayavkaAuto' . "\0" . 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ZayavkaAuto $proxy) {
