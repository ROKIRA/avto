 ...
 */
class Comment extends \Auto\MainBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id_auto', 'name', 'email', 'text', 'date_add', 'public', 'parent_id', '' . "\0" . 'Auto\\MainBundle\\Entity\\Comment' . "\0" . 'id');
        }
