 ...
 */
class Marka extends \Auto\MainBundle\Entity\Marka implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'mark', '' . "\0" . 'Auto\\MainBundle\\Entity\\Marka' . "\0" . 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Marka $proxy) {
