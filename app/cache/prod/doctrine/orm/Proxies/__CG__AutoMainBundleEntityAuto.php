 ...
 */
class Auto extends \Auto\MainBundle\Entity\Auto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'region', 'mark', 'model', 'body', 'img', 'file', 'year', 'color', 'run', 'new', 'vip', 'price', 'description', '' . "\0" . 'Auto\\MainBundle\\Entity\\Auto' . "\0" . 'id', '' . "\0" . 'Auto\\MainBundle\\Entity\\Auto' . "\0" . 'lifecycleCallbacks');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Auto $proxy) {
    ...
    public function setRun($run)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRun', array($run));
    ...
    public function getRun()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRun', array());
